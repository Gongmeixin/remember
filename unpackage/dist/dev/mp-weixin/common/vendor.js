...
const pages = [
  ...
  {
    path: "pages/index/homework/homework",
    style: {
  ...
  {
    path: "pages/index/homework/homeworkDetail",
    style: {
      navigationBarTitleText: "测试",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/personal/testDatile/testDatile",
    style: {
  ...
  {
    path: "pages/index/dictationTest/dictationTest",
    style: {
      navigationBarTitleText: "听写",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/index/dictationTest/dictationTestDetail",
    style: {
      navigationBarTitleText: "听写",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/personal/D_testDetail/D_testDetail",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  list: [
    {
      ...
      text: "首页",
      iconPath: "static/image/首页-置灰.png",
      selectedIconPath: "static/image/首页-置灰-copy.png"
    },
    {
      pagePath: "pages/personal/index",
      text: "我的",
      iconPath: "static/image/个人中心-置灰.png",
      selectedIconPath: "static/image/个人中心-置灰-copy.png"
    }
  ]
};
const t = {
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "169.254.112.172",\n        "192.168.137.1",\n        "10.218.62.189"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"remember","spaceId":"mp-3ad79771-d8d5-41a5-b4f8-02cc04752fcd","clientSecret":"PuixIptfuE9UXFFcJ+YPlw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__AD94101";
} catch (e2) {
